	...
	public class LeechingTetherHook : ModProjectile
	{
		...
		public void Lifesteal(NPC target)
		{
			if (Projectile.owner == Main.myPlayer)
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Projectile.velocity * 0f, ModContent.ProjectileType<LeechingTetherHeal>(), 0, 0f, Projectile.owner, healTargetID, 3f);
			}
		}
